<div class="ios content-item" style="display: none;">
	<div class="row-fluid centered-text">
		<div class="span6">
			...
			(Cydia link)
			<br/>
			<img src="/img/Minimalist%20Moment%20of%20Silence.png" alt="Minimalist Moment of Silence" class="img-rounded"/>
			<br/>
			<br/>
		...
		<div class="span6">
			...
			(Cydia link)
			<br/>
			<img src="/img/Scrolling%20Time-Date%20Lockscreen%20HD.png" alt="Scrolling Time/Date Lockscreen" class="img-rounded"/>
			<br/>
			<br/>
