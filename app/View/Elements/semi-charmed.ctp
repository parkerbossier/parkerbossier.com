<div class="span4 card card-rounded">
    <div class="inner-card">
        <img class="card-rounded card-preview" src="/img/semi-charmed-preview.png" alt="Semi-Charmed Call Me Maybe Kinetic Typography preview image"/>

        <div class="description-wrapper">
            <a href="http://www.youtube.com/watch?v=Up-BZHaE6nY" target="_blank">
                <h2 class="about-header no-margin-bottom">Kinetic Typography</h2>
