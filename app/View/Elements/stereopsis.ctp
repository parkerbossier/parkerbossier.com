<div class="stereopsis content-item" style="display: none;">
	<div class="row-fluid centered-text">
		<h2>
			<a href="/files/pdfs/Computer%20Vision%20Final%20Project.pdf" target="_blank">
				Depth by Stereopsis (Head Tracking)
			</a>
		</h2>
	</div>
	...
	<div class="row-fluid">
		<div class="span6 offset3 centered-text">
			(note: PDF link)
			<img src="/img/stereopsis-preview.png" class="img-rounded" alt="Stereopsis frames"/>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class="span10 offset1">
			<p>
				My final project in Computer Vision at Vanderbilt. Below is the introduction.
			</p>
