<div class="turing content-item" style="display: none;">
    ...
    <div class="row-fluid">
        <div class="span10 offset1">
            <p>
                I took an automata course in undergrad where we covered Turing machines among the various automatons we studied. I thought the concept was pretty interesting and relatively easy to implement, so below is a JavaScript version of one. There are no formal accept states. Instead, upon termination, the app alerts the final state. I did it this way to keep the app simple.
            </p>
        </div>
    </div>
