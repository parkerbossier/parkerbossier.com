<?php
$this->set('subtitle', 'Flash Projects');
...
<div class="container">
	<div class="row">
	<div class="span12">
			<h1 class="centered-text">Flash Projects</h1>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="span6 centered-text">
			<embed src="/files/flash/Curving%20Balls.swf" width="550" height="400" type="application/x-shockwave-flash" style="background-color: black;">
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="span6 centered-text">
			<embed src="/files/flash/Fifteen%20Puzzle.swf" width="450" height="500" type="application/x-shockwave-flash" wmode="transparent">
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="span6 centered-text">
			<embed src="/files/flash/Binary%20Clock.swf" width="550" height="400" type="application/x-shockwave-flash" wmode="transparent">
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="span6 centered-text">
			<embed src="/files/flash/Clock%20Tick.swf" width="550" height="400" type="application/x-shockwave-flash" wmode="transparent">
		</div>
	</div>
