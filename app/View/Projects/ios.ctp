<?php
	$this->set('active_tab_for_layout', 'ios');
	$this->set('subtitle_for_layout', 'iOS Projects');
?>
...
<div class="container">
	...
	<div class="row">
		<div class="span6">
			<h2><a href="http://modmyi.com/info/minimalistmomentofsilence.d.php" target="_blank">
		...
		<div class="span6">
			<h2><a href="http://modmyi.com/info/scrollingtimedatelockscreenhd.d.php" target="_blank">
