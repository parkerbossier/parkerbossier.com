...
$(function() {
    ...
    $('#run').click(function() {
        ...
        // run!
        setTimeout(function() {
            // not that the blank value is set here so thet the user can't modify the blank that the
            // code sees during execution
            run(matrix[0][0], 0, $('#tape').val(), $('#blank_symbol').val());
        }, speed);
    });
});
